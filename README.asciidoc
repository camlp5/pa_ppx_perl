`pa_ppx_regexp`: a PPX Rewriter for Perl-ish regexp operations
============================================================
:toc:
...
pattern that does have capture-groups has type `Re.substrings ->
string` (or `Pcre.substrings -> string`) (since those capture-groups
